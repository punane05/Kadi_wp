...
function srz_fb_enqueue_script() {
	...
	wp_enqueue_script( 'srzcustom', srz_fb_get_resource_url( 'resources/js/srizon.custom.min.js' ), array( 'jquery' ), '3.4.1' );
	...
	wp_enqueue_style( 'srzcustomcss', srz_fb_get_resource_url( 'resources/css/srizon.custom.min.css' ), null, '3.4.1' );
}
