...
?>
    <form action="admin.php?page=SrzFb" method="post">
        <table class="srzfb-admin-common">
            ...
            <tr>
                <td colspan="2">
                    <strong><?php _e( 'Access Token creation moved to a dedicated site <a href="https://fb.srizon.com" target="_blank">fb.srizon.com</a>', 'srizon-facebook-album' ); ?></strong><br>
                    <br>
        ...
        <tr>
            <td>
                <ol>
                    ...
                    <li><?php _e( 'A textbox will expand. Put the following code there', 'srizon-facebook-album' ); ?>
                        <br/>
